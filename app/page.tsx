...
const HeroSection = async () => {
  ...
  return (
    <section id="hero" className="pt-32 xl:pt-36">
      <div
        id="hero-content"
        className="flex flex-col justify-center items-center w-full gap-y-4 text-center"
      >
...
const AboutSection = async () => {
  ...
  return (
    <section id="about">
      ...
      >
        <h2 className="w-fit bg-left-bottom bg-gradient-to-r from-google-mediumRed to-google-mediumRed bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out">
          About
        </h2>
...
const SponsorsSection = async () => {
  ...
  return (
    <section id="sponsors">
      ...
      >
        <h2 className="w-fit bg-left-bottom bg-gradient-to-r from-google-mediumBlue to-google-mediumBlue bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out">
          Sponsors
        </h2>{" "}
  ...
  return (
    <section id="faq">
      <div
        ...
        className="flex flex-col gap-y-8 md:gap-y-16 w-full group transition-all duration-300 ease-in-out"
      >
        <h2 className="w-fit bg-left-bottom bg-gradient-to-r from-google-mediumGreen to-google-mediumGreen bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out">
          FAQ
        </h2>
